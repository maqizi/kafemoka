	...
	<div>
		<el-row style="width: 100%; padding: 0.75rem 0; display: flex; justify-content: space-between; align-items: center;">
		    <el-col :span="8" style="text-align: left;margin-left: 1.875rem;">  
		      <p><el-button type="primary">实验2：纯文本编辑器+ChatGPT</el-button></p>  
			  <p><el-tag type="warning">右侧第一个蓝色图标为chatgpt</el-tag></p>
			  <p><el-tag type="warning">教案任务详细介绍请点击最右侧第2个蓝色图标</el-tag></p>
			  
		    </el-col>  
			<el-col :span="8" style="text-align: center;">  
			<el-button @click="startTimer">开始实验</el-button>
			<el-button>实验经历时间：{{ elapsedTime }}</el-button>
			</el-col>
		    <el-col :span="8" style="text-align: right;margin-right: 0.875rem;">  
		      <el-button icon="el-icon-coin" @click="saveedu()">完成实验</el-button>  
		...
		<el-dialog title="实验完成信息" :visible.sync="dialogForm4Visible">
		    ...
		    <p>填写网址：<a href="https://www.wjx.cn/vm/wnEqfjh.aspx" target="_blank">实验2 调查问卷</a> <p>
			<p>填写完毕后，请点击回到实验任务首页:</p>
			<el-button>实验任务首页</el-button>
	...
	export default {
		...
		data() {
			return {
				...
				prom:'你是教学设计机器人，请你为老师设计一份优质且详细的教案，我将为你提供教学的基本信息以及教学模式。\n'+
                '教学基本信息:\n'+
                '年级科目：六年级数学\n'+
                '教学主题：圆的认识\n'+
                '教学模式-\n'+
		...
		mounted() {
			...
			this.options4=[`1-您在此实验中被分配的教案任务为:${this.matchT}`,'2-在此实验中，希望您能通过chatgpt进行生成一份教案，并且至少一次向chatgpt提问进行优化调整教案内容。',
			'3-点击 开始实验 按钮之后，会开始计时，直到点击完成实验 按钮之后，结束此次教案设计。',
			'4-您还可以参考我们的教学模式库或者自定义教学模式进行设计教学过程。','5-最右侧第三个图标有可以参考的向chatgpt进行提问的初始提示词。'];
