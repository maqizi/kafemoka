	...
	<div>
		<el-row style="width: 100%; padding: 0.75rem 0; display: flex; justify-content: space-between; align-items: center;">
		    <el-col :span="8" style="text-align: left;margin-left: 1.875rem;">  
		      <p><el-button type="primary">实验4：智能教案生成+AI教案助手</el-button></p>  
			  <p><el-tag type="info">实验任务详细介绍</el-tag></p>
		    </el-col>  
											...
											<div>
												...
												<div v-if="message.sender=='AI'"
													...
													<div :class="{'btn_p':message.content[0]!=''}">
														...
														<el-rate v-if="message.content[0]!=''" @change="handleTime(message.rate,index)"  v-model="message.rate" show-text  :colors="['#99A9BF', '#a0cff7', '#3a93ff']"  style="width: 180px;">
														</el-rate>
		...
		<el-dialog title="实验完成信息" :visible.sync="dialogForm4Visible">
		    ...
		    <p>填写网址：<a href="https://www.wjx.cn/vm/rL1gQDN.aspx" target="_blank">实验4 调查问卷</a> <p>
	...
	export default {
		...
		data() {
			return {
				...
				list: [],
				loading: false,
				states: [" 这一部分是否有遗漏或不准确的地方？", " 是否存在逻辑上的跳跃或不一致之处？", " 我的班级学习风格为[填入学习风格]，考虑到我的班级学生的班级学习风格，你建议如何调整这个教案的学习目标？",
					" 哪些策略可以帮助我更有效地教授难懂的概念？", " 哪些类型的作业任务可以促进学生的创造力？", " 我的班级有[填入班级人数]，考虑到我的班级大小，你有什么建议来管理小组工作？",
					" 哪些案例研究最适合我的教案主题？", " 哪些问题和讨论话题可以作为课堂辩论的良好起点？", " 哪些策略可以帮助提高教案中的协作学习成分？",
					" 这一部分是否包含了足够的案例来帮助学生理解复杂概念？", "哪些案例研究或现实世界例子可以加强教案内容？", " 能否列举个非常容易理解的例子", " 重新生成教学内容分析，使得教学内容分析变得更加[填入词语]",
					" 这一部分的教案内容我觉得需要更多的视觉辅助或实例说明来说明，你能帮助我吗", "Iowa", "Kansas", "Kentucky",
			...
			async generateTextStreamToParagraph() {
				...
				if(selectStr==''){
					us =`${this.inputMessage}.`;
					 ...
					 us = `我的教案主题是  ${this.teachInfo} 。我选中的一段话是${selectStr}.修改要求是${this.inputMessage}.请你根据我提出的需求和教案主题修改我选中的一段话，输出修改的内容即可，无需其他话语。让我们一步一步思考，确保得出正确的结论`;
				}
