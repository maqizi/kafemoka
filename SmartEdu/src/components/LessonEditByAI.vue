	...
	<div>
		<el-header style="text-align: right; ">
			  ...
			  <el-form :model="form">
			    ...
			    <el-form-item label="用户权限" :label-width="formLabelWidth">
			      <el-select v-model="form.region" placeholder="请选择用户权限">
			        ...
			        <el-option label="评论" value="assess"></el-option>
			...
			<el-dialog title="教案下载" :visible.sync="dialogdownload">
				<el-button icon="el-icon-download" @click="convertToPdf">PDF下载</el-button>
				<!-- <el-button icon="el-icon-download" @click="changeStyleCom">a下载</el-button> -->
				<el-button icon="el-icon-download" @click="convertToword">WORD下载</el-button>
				<div slot="footer" class="dialog-footer">
...
<script>
	...
	export default {
		...
		mounted() {
			...
			// const voiceTxt = this.inputMessage;
