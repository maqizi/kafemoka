    ...
    <div class="SetBackground"> 
        ...
        <el-form ref="form" :model="form" label-width="80px" @submit.native.prevent >
            ...
            <div style="padding-top: 0.725rem;">
				...
				<div class="hayabox">请注意，您在此实验中的教案主题为：<<{{matchT}}>>,请在以下课程信息中输入或者选择对应的教案主题。</div>
				<div class="hayabox">请点击开始实验，开始实验点击之后，开始计时。</div>
				<div class="hayabox">
                ...
                <div class="block">
					...
					<el-checkbox-group v-model="checkboxValues">
					    ...
					    <el-checkbox label="教学过程(必选)" disabled border ></el-checkbox>
					    <el-checkbox label="教学重难点"  border @click="Vision"></el-checkbox>
					    <el-checkbox label="教学目标"  border></el-checkbox>
				...
				<div class="block">
					...
					<div class="container container-with-shadow" >
					    ...
					    <el-aside width="200px" style="overflow-y:auto;height: 100%;">
					        ...
					        <el-menu-item index="1">探究式教学</el-menu-item>
					        <el-menu-item index="2">讲授式教学</el-menu-item>
					        <el-menu-item index="3">协作式教学</el-menu-item>
					        <el-menu-item index="4">自定义教学</el-menu-item>
					    ...
					    <el-main class="content-container" style="overflow-y: auto;height: 100%;">
					        <div  v-if="currentTab === '1'" style="height: 100%;">
					            <div>
    ...
    export default {
        ...
        data() {
            return {
				...
				teachMode:[{
					teachModeName:'探究式教学',
					modeIntro:'探究式教学以问题解决为中心的，注重学生的独立活动，注重体验式教学，着眼于学生的思维能力的培养。',
					modeClip:['情境创设，课程导入','分析问题，明确目标','动手实践，探究新知','课堂总结，建构概念','知识巩固，迁移应用'],
				}
